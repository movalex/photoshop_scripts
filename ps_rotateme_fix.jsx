...
if (win.show() == 1) { 
app.activeDocument.suspendHistory("[KAM] RotateMe 3 Script (Learn more: http://blog.kam88.com)", "rotateMe3(aLayer, steps_sl.value, radius_sl.value, rotation_sl.value, rotateRelativePath.value, saveOriginal.value, groupLayers.value)");
}
}
else {
